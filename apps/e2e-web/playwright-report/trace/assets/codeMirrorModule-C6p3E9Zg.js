import { p as bu, q as ku } from "./workbench-DrQjKdyE.js";
var ya = { exports: {} };
(function (jt, Jt) {
  (function (F, Pe) {
    jt.exports = Pe();
    ...
    function Ri(e, t) {
      ...
      return (
        ...
        t.left < 10
          ...
          : t.right > x + b - 3 && (l.scrollLeft = t.right + (D ? 0 : 10) - x),
        l
      );
    }
    function qi(e, t) {
  ...
  (function (F) {
    ...
    F.defineMode("css", function (le, W) {
      ...
      function Ee(T, z) {
        ...
        } else return /[,+>*\/]/.test(M) ? te(null, "select-op") : M == "." && T.match(/^-?[_a-z][_a-z0-9-]*/i) ? te("qualifier", "qualifier") : /[:;{}\[\]\(\)]/.test(M) ? te(null, M) : T.match(/^[\w-.]+(?=\()/) ? (/^(url(-prefix)?|domain|regexp)$/i.test(T.current()) && (z.tokenize = Ve), te("variable callee", "variable")) : /[\w\\\-]/.test(M) ? (T.eatWhile(/[\w\\\-]/), te("property", "word")) : te(null, null);
      }
      function qe(T) {
        return function (z, M) {
        ...
        (function (F) {
          ...
          F.defineMode("xml", function (de, Me) {
            ...
            function P(d, S) {
              ...
              } else return /[\'\"]/.test(w) ? ((S.tokenize = K(w)), (S.stringStartCol = d.column()), S.tokenize(d, S)) : (d.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word");
            }
            function K(d) {
              var S = function (w, m) {
                for (; !w.eol(); )
            ...
            function ue(d, S, w) {
              ...
              } else return k.allowMissingTagName && d == "endTag" ? ((O = "tag bracket"), ze(d, S, w)) : ((O = "error"), le);
            }
            function ze(d, S, w) {
                ...
                ? U && g == "declare"
                  ...
                  ? ((C.marked = "keyword"),
                    g == "enum"
                      ? d(ae)
                      : g == "type"
                      ? d(_n, Se("operator"), We, Se(";"))
                      : d(R("form"), yt, Se("{"), R("}"), Et, oe, oe))
                  : U && g == "namespace"
                  ? ((C.marked = "keyword"), d(R("form"), te, Te, oe))
                  : U && g == "abstract"
                  ? ((C.marked = "keyword"), d(Te))
                  : d(R("stat"), Ie)
                : f == "switch"
                ? d(R("form"), qe, Se("{"), R("}", "switch"), G, Et, oe, oe, ye)
                : f == "case"
                ? d(te, Se(":"))
                : f == "default"
                ? d(Se(":"))
            ...
            return {
              ...
              indent: function (f, g) {
                ...
                return it == "vardef"
                  ...
                  : B.info == "switch" && !xt && I.doubleIndentSwitch != !1
                  ? B.indented + (/^(?:case|default)\b/.test(g) ? de : 2 * de)
                  : B.align
                  ? B.column + (xt ? 0 : 1)
                  : B.indented + (xt ? 0 : de);
              },
