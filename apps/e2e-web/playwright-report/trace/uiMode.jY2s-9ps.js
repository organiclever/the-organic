...
import {
  ...
  a as Gt,
  c as Jt,
} from "./assets/workbench-DrQjKdyE.js";
      ...
      a = (r) => {
        ...
        return !i.every((d) => m.includes(d)) &&
          ...
          : ((r.children = r.children.filter(
              (d) =>
                !l || (s == null ? void 0 : s.has(d.test.id)) || e.get(d.status)
            )),
          ...
          children: [
            n.jsxs("div", {
              ...
              children: [
                ...
                u.kind === "case"
                  ? u.tags.map((B) =>
                      n.jsx(fe, { tag: B.slice(1), onClick: (x) => J(x, B) }, B)
                    )
                  : null,
              ],
            }),
...
const ve = ({ item: o, rootDir: t, onOpenExternally: e, revealSource: s }) => {
    ...
    return (
      c.useEffect(() => {
        ...
        const R = `${m}/${_e(T.workerIndex)}/traces/${
          (C = o.testCase) == null ? void 0 : C.id
        }.json`;
        return (
