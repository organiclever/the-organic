...
def echo_instancemethod(
    klass: type,
    method: MethodType,
    write: Callable[[str], int | None] = sys.stdout.write,
) -> None:
...
def echo_class(
    klass: type, write: Callable[[str], int | None] = sys.stdout.write
) -> None:
...
def echo_module(
    mod: MethodType, write: Callable[[str], int | None] = sys.stdout.write
) -> None:
